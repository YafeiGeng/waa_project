...
public class ProductServiceImpl implements ProductService{
	...
	/*
	 * Uses the Specification Interface to pass Criteria into findAll
	 * This is the way to use the Criteria API with Spring Data
	 */
 	public List<Product> findBySpec(Product product) {
